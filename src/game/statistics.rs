use super::{PetType, Achievement, Deserialize, Serialize, Theme, default_elo, default_unlocked_themes, Resource, CraftableItem, Bounty};
...
pub struct Statistics {
    ...
    #[serde(default)]
    pub unlocked_pets: Vec<PetType>,
    #[serde(default)]
    pub equipped_pet: Option<PetType>,
}
