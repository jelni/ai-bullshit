...
fn draw_background<W: Write>(game: &Game, stdout: &mut W) -> io::Result<()> {
    ...
    if game.mode == crate::game::GameMode::TurfWar {
        ...
        stdout.queue(crossterm::style::SetBackgroundColor(crossterm::style::Color::Reset))?;
    }
...
fn draw_entities<W: Write>(
        ...
        && is_visible(power_up.location.x, power_up.location.y)
    {
        ...
        match power_up.p_type {
            ...
            crate::game::PowerUpType::Invisibility => {
                stdout.queue(SetForegroundColor(Color::White))?;
                write!(stdout, "I")?;
            },
            _ => {
...
fn draw_base_status<W: Write>(
    ...
    if game.mode == crate::game::GameMode::CaptureTheFlag
        || game.mode == crate::game::GameMode::KingOfTheHill
    {
        write!(
            stdout,
        ...
        && let Some(activation_time) = power_up.activation_time
    {
        ...
        if elapsed < duration {
            ...
            let power_up_name = match power_up.p_type {
                ...
                crate::game::PowerUpType::Invisibility => "Invisibility",
                crate::game::PowerUpType::Mitosis => "Mitosis",
            };
...
fn draw_class_select<W: Write>(game: &Game, stdout: &mut W) -> io::Result<()> {
    ...
    let classes = [
        ...
        (
            "Druid",
            crate::game::HeroClass::Druid,
            "Converts poison food into bonus points and ignores weather penalties",
        ),
        ("Engineer", crate::game::HeroClass::Engineer, "Periodically deploys a friendly Turret"),
    ];
