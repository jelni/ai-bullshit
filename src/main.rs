...
fn handle_menu_input(code: KeyCode, game: &mut Game) -> bool {
    match code {
        ...
        KeyCode::Char(' ') | KeyCode::Enter => match game.menu_selection {
            ...
            40 => game.state = GameState::Settings,
            41 => game.state = GameState::NftShop,
            42 => game.state = GameState::SkillTree,
            43 => game.state = GameState::Stats,
            44 => game.state = GameState::Achievements,
            45 => game.state = GameState::Help,
            46 => {
        ...
        KeyCode::Up | KeyCode::Char('w' | 'W') => {
            if game.menu_selection > 0 {
                ...
                game.menu_selection = 71;
            }
        },
        KeyCode::Down | KeyCode::Char('s' | 'S') => {
            if game.menu_selection < 71 {
                game.menu_selection += 1;
            } else {
