...
fn handle_menu_input(code: KeyCode, game: &mut Game) -> bool {
    match code {
        ...
        KeyCode::Char(' ') | KeyCode::Enter => match game.menu_selection {
            ...
            41 => game.state = GameState::Settings,
            42 => game.state = GameState::NftShop,
            43 => game.state = GameState::SkillTree,
            44 => game.state = GameState::Stats,
            45 => game.state = GameState::Achievements,
            46 => game.state = GameState::Help,
            47 => {
        ...
        KeyCode::Up | KeyCode::Char('w' | 'W') => {
            if game.menu_selection > 0 {
                ...
                game.menu_selection = 72;
            }
        },
        KeyCode::Down | KeyCode::Char('s' | 'S') => {
            if game.menu_selection < 72 {
                game.menu_selection += 1;
            } else {
